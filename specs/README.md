...
| [0018](0018-workflow-hooks.md) | Workflow enforcement hooks — no commit on `main`, no malformed spec, no push while `verify` is red, no merge on a `verify` that is not green | in-progress — 6 done · 2 revised |
