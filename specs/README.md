...
| [0014](0014-wizard-back.md) | The wizard can go back without losing an answer, and step 02 echoes the title you typed | done — 8 done · 2 revised (R8 instrument, R9 boundary moved by 0016) · merged at `8d3b7e9` |
...
| [0019](0019-nextjs-typescript-migration.md) | Vite → Next.js App Router as a static export, and the whole app JS → TypeScript under `strict` — the migration that makes a URL per country possible | in-progress |
