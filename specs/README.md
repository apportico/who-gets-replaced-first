...
| [0016](0016-url-state.md) | The wizard's state lives in the URL — a query string on the existing path, cold-load restore, browser Back walking the steps, and a copy-link on the result | draft |
