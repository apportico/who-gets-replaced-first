...
| [0013](0013-country-fold.md) | Step 01 opens folded — the selected country alone, a 12-row cap on matches and a 3-row cap on the stated absences, both truncations stated; and the 0011 criteria that passed against a 12,294px list tightened | in-review |
