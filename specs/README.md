...
| [0019](0019-nextjs-typescript-migration.md) | Vite → Next.js App Router as a static export, and the whole app JS → TypeScript under `strict` — the migration that makes a URL per country possible | draft |
