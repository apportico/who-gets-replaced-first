...
| [0015](0015-share-card.md) | The result survives leaving the site — one `h1` per screen, a methodology page, site-level OG/Twitter meta, and a client-side share card carrying its tiers and the stand-in disclosure, never a year | draft |
