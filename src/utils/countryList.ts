 ...
 */
export function hasAnyIscoGroup(row: LaborRow | null | undefined) {
  if (!row) return false
  return GROUPS.some((g) => row[g.key] !== null && row[g.key] !== undefined)
}

function shape(r: LaborRow): CountryOption {
 ...
 */
export function countryOptions(rows: readonly LaborRow[] | null | undefined) {
 ...
 */
export function excludedCountries(rows: readonly LaborRow[] | null | undefined) {
 ...
 */
export function localeCountry(rows: readonly LaborRow[] | null | undefined, locale: string | null | undefined) {
